	...
	<div class="container">
		...
		<div class="about-top-grids">
			<div class="col-md-5 about-top-grid">
				<img src="assets/dist/images/2.png" alt=""/>
			</div>
		...
		<div class="team-grids">
			<div class="col-md-3 team-grid">
				...
				<div class="col-md-3 team-grid">
					...
					<h6>Heny Sison</h6>
					<p>Popularly known as Chef Heny, is a pastry chef, cake decorator, and television host in the Philippines.</p>
				</div>
				<div class="col-md-3 team-grid">
					<img src="assets/dist/images/marvin.jpg" alt="">
					<h6>Marvin Agustin</h6>
					<p>Better known by his stage name, Marvin Agustin, (born January 29, 1979) is a Filipino actor, chef and entrepreneur.</p>
				</div>
				<div class="col-md-3 team-grid">
					<img src="assets/dist/images/hasset.jpg" alt="">
					<h6>Hasset Go</h6>
					<p>Popularly known as Hasset Go or Chef Hasset (August 8, 1986 – October 24, 2015) was a Filipino celebrity chef and entrepreneur. He appeared in several television shows and gained prominence nationwide.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
